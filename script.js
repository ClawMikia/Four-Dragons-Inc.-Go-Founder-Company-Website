(() => {
  ...
  const translations = {
    en: {
      ...
      mindsetQuote2: 'The Founder, CEO &amp; Chairman can be a teacher — but he chooses to remain a student most of the time.',
      mindsetText2: 'He is only here to serve the people, so they can build a beautiful future together.',
      ...
      rejectScam: 'Scam',
      rejectCriticism: 'Criticism',
      rejectAnyCriticism: 'Any form of criticism',
      ...
      footerSub: 'Christopher Lee Cajes · Founder, 会長 (Kaichou)',
      navFamily: 'Our Family',
      familyVol: 'Our Family',
      familyTitle: 'We are brothers and sisters',
      familyLead: 'Four Dragons is not a hierarchy. It is a family. Titles are just friendly Japanese terms — they do not divide us. We are all 仲間 (nakama) — comrades, friends, family.',
      orgFounder: 'Christopher Lee Cajes',
      orgFounderTitle: 'Founder, CEO &amp; Chairman',
      orgCoFounder1: 'Co-Founder',
      orgCoFounder1Title: '共同創設者 (Kyōdō-sōsetsusha)',
      orgCoFounder2: 'Co-Founder',
      orgCoFounder2Title: '共同創設者 (Kyōdō-sōsetsusha)',
      orgCoFounder3: 'Co-Founder',
      orgCoFounder3Title: '共同創設者 (Kyōdō-sōsetsusha)',
      orgCoFounder4: 'Co-Founder',
      orgCoFounder4Title: '共同創設者 (Kyōdō-sōsetsusha)',
      orgCoFounder5: 'Co-Founder',
      orgCoFounder5Title: '共同創設者 (Kyōdō-sōsetsusha)',
      orgVP1: 'Vice President',
      orgVP1Title: '副会長 (Fuku-kaichou)',
      orgVP2: 'Vice President',
      orgVP2Title: '副会長 (Fuku-kaichou)',
      orgVP3: 'Vice President',
      orgVP3Title: '副会長 (Fuku-kaichou)',
      orgVP4: 'Vice President',
      orgVP4Title: '副会長 (Fuku-kaichou)',
      orgVP5: 'Vice President',
      orgVP5Title: '副会長 (Fuku-kaichou)',
      orgVP6: 'Vice President',
      orgVP6Title: '副会長 (Fuku-kaichou)',
      orgVP7: 'Vice President',
      orgVP7Title: '副会長 (Fuku-kaichou)',
      orgVP8: 'Vice President',
      orgVP8Title: '副会長 (Fuku-kaichou)',
      orgVP9: 'Vice President',
      orgVP9Title: '副会長 (Fuku-kaichou)',
      orgVP10: 'Vice President',
      orgVP10Title: '副会長 (Fuku-kaichou)',
      orgSenpai1: 'Games Lead',
      orgSenpai1Title: 'Games 先輩',
      orgSenpai2: 'Anime Lead',
      orgSenpai2Title: 'Anime 先輩',
      orgSenpai3: 'Music Lead',
      orgSenpai3Title: 'Music 先輩',
      orgSenpai4: 'Film Lead',
      orgSenpai4Title: 'Film 先輩',
      orgSenpai5: 'Operations Lead',
      orgSenpai5Title: 'Operations 先輩',
      orgSenpai6: 'Creative Lead',
      orgSenpai6Title: 'Creative 先輩',
      orgSupport1: 'Janitor',
      orgSupport1Title: '管理人 (Kanrinin)',
      orgSupport2: 'Cook',
      orgSupport2Title: '料理人 (Ryōrinin)',
      orgSupport3: 'Guard',
      orgSupport3Title: '警備 (Keibi)',
      orgSupport4: 'Maintenance',
      orgSupport4Title: '整備 (Seibi)',
      orgSenpai7: 'Education Lead',
      orgSenpai7Title: 'Education 先輩',
      orgSenpai8: 'Art Lead',
      orgSenpai8Title: 'Art 先輩',
      orgSenpai9: 'Theater Lead',
      orgSenpai9Title: 'Theater 先輩',
      orgSenpai10: 'Culture Lead',
      orgSenpai10Title: 'Culture 先輩',
      orgSupport5: 'Accountant',
      orgSupport5Title: '会計 (Kaikei)',
      orgSupport6: 'Driver',
      orgSupport6Title: '運転 (Unten)',
      orgCreator1: 'Creator',
      orgCreator1Title: 'Creator (voluntary)',
      orgCreator2: 'Creator',
      orgCreator2Title: 'Creator (voluntary)',
      orgCreator3: 'Creator',
      orgCreator3Title: 'Creator (voluntary)',
      orgCreator4: 'Creator',
      orgCreator4Title: 'Creator (voluntary)',
      orgCreator5: 'Creator',
      orgCreator5Title: 'Creator (voluntary)',
      orgCreator6: 'Creator',
      orgCreator6Title: 'Creator (voluntary)',
      orgCreator7: 'Creator',
      orgCreator7Title: 'Creator (voluntary)',
      orgCreator8: 'Creator',
      orgCreator8Title: 'Creator (voluntary)',
      orgCreator9: 'Creator',
      orgCreator9Title: 'Creator (voluntary)',
      orgCreator10: 'Creator',
      orgCreator10Title: 'Creator (voluntary)',
      orgTester1: 'Tester',
      orgTester1Title: 'Tester',
      orgTester2: 'Tester',
      orgTester2Title: 'Tester',
      orgTester3: 'Tester',
      orgTester3Title: 'Tester',
      orgTester4: 'Tester',
      orgTester4Title: 'Tester',
      orgTester5: 'Tester',
      orgTester5Title: 'Tester',
      orgTester6: 'Tester',
      orgTester6Title: 'Tester',
      orgTester7: 'Tester',
      orgTester7Title: 'Tester',
      orgTester8: 'Tester',
      orgTester8Title: 'Tester',
      orgTester9: 'Tester',
      orgTester9Title: 'Tester',
      orgTester10: 'Tester',
      orgTester10Title: 'Tester',
      familyRule1Title: 'No "ma\'am" or "sir"',
      familyRule1Text: 'We call each other by our first names, nicknames, or friendly terms like 先輩 (senpai) and 後輩 (kohai). Formality creates distance — warmth creates family.',
      familyRule2Title: 'No "staff" or "employees"',
      familyRule2Text: 'We do not use corporate labels. Everyone here is a 仲間 (nakama) — a comrade, a creator, a member of the family.',
      familyRule3Title: 'Equal by birthright',
      familyRule3Text: 'Regardless of title, role, or experience, we are all brothers and sisters. Titles do not determine worth. Heart does.',
    },
    ja: {
      navHome: 'ホーム',
      navCreations: '作品',
      ...
      heroFounder: 'クリストファー・リー・カヘス — 創業者・会長（Kaichou）',
      heroPrimary: '作品を見る',
      ...
      mindsetQuote2: '創業者・会長（Kaichou）は教師になることもできる — しかし彼は大半の時間を生徒でいることを選ぶ。',
      mindsetText2: '彼は人々に仕えるためにここにいる。彼らが共に美しい未来を築くために。',
      valuesVol: '四つの核心価値',
      valuesTitle: '四つの柱',
      ...
      footerSub: 'クリストファー・リー・カヘス · 創業者・会長（Kaichou）',
      navFamily: '私たちの家族',
      familyVol: '私たちの家族',
      familyTitle: '私たちは兄弟姉妹',
      familyLead: 'Four Dragons は階級ではない。家族である。肩書きは友好的な日本語の表現に過ぎない — 私たちを分断することはない。私たちはみな 仲間（nakama）— 戦友、友人、家族。',
      orgFounder: 'クリストファー・リー・カヘス',
      orgFounderTitle: '創業者・会長（Kaichou）',
      orgCoFounder1: '共同創設者',
      orgCoFounder1Title: '共同創設者（Kyōdō-sōsetsusha）',
      orgCoFounder2: '共同創設者',
      orgCoFounder2Title: '共同創設者（Kyōdō-sōsetsusha）',
      ...
      orgVP10Title: '副会長（Fuku-kaichou）',
      orgSenpai1: 'ゲーム責任者',
      orgSenpai1Title: 'ゲーム 先輩',
      orgSenpai2: 'アニメ責任者',
      orgSenpai2Title: 'アニメ 先輩',
      orgSenpai3: '音楽責任者',
      orgSenpai3Title: '音楽 先輩',
      orgSenpai4: '映画責任者',
      orgSenpai4Title: '映画 先輩',
      orgSenpai5: 'オペレーション責任者',
      orgSenpai5Title: 'オペレーション 先輩',
      orgSenpai6: 'クリエイティブ責任者',
      orgSenpai6Title: 'クリエイティブ 先輩',
      orgSupport1: '管理人',
      orgSupport1Title: '管理人（Kanrinin）',
      orgSupport2: '料理人',
      orgSupport2Title: '料理人（Ryōrinin）',
      ...
      orgSupport4Title: '整備（Seibi）',
      orgSenpai7: '教育責任者',
      orgSenpai7Title: '教育 先輩',
      orgSenpai8: 'アート責任者',
      orgSenpai8Title: 'アート 先輩',
      orgSenpai9: 'シアター責任者',
      orgSenpai9Title: 'シアター 先輩',
      orgSenpai10: '文化責任者',
      orgSenpai10Title: '文化 先輩',
      orgSupport5: '会計',
      orgSupport5Title: '会計（Kaikei）',
      orgSupport6: '運転',
      orgSupport6Title: '運転（Unten）',
      orgCreator1: '創作者',
      orgCreator1Title: '創作者（任意）',
      orgCreator2: '創作者',
      orgCreator2Title: '創作者（任意）',
      orgCreator3: '創作者',
      orgCreator3Title: '創作者（任意）',
      orgCreator4: '創作者',
      orgCreator4Title: '創作者（任意）',
      orgCreator5: '創作者',
      orgCreator5Title: '創作者（任意）',
      orgCreator6: '創作者',
      orgCreator6Title: '創作者（任意）',
      orgCreator7: '創作者',
      orgCreator7Title: '創作者（任意）',
      orgCreator8: '創作者',
      orgCreator8Title: '創作者（任意）',
      orgCreator9: '創作者',
      orgCreator9Title: '創作者（任意）',
      orgCreator10: '創作者',
      orgCreator10Title: '創作者（任意）',
      orgTester1: 'テスター',
      orgTester1Title: 'テスター',
      orgTester2: 'テスター',
      orgTester2Title: 'テスター',
      orgTester3: 'テスター',
      orgTester3Title: 'テスター',
      orgTester4: 'テスター',
      orgTester4Title: 'テスター',
      orgTester5: 'テスター',
      orgTester5Title: 'テスター',
      orgTester6: 'テスター',
      orgTester6Title: 'テスター',
      orgTester7: 'テスター',
      orgTester7Title: 'テスター',
      orgTester8: 'テスター',
      orgTester8Title: 'テスター',
      orgTester9: 'テスター',
      orgTester9Title: 'テスター',
      orgTester10: 'テスター',
      orgTester10Title: 'テスター',
      familyRule1Title: '「様」「さん」は使わない',
      familyRule1Text: '名前やニックネーム、あるいは 先輩（senpai）や 後輩（kohai）のような親しみやすい表現で呼び合う。形式は距離を生み、温かさは家族を生む。',
      familyRule2Title: '「スタッフ」も「従業員」も使わない',
      familyRule2Text: '企業的なレッテルは使わない。ここにいる全員が 仲間（nakama）— 戦友、創作者、家族の一員。',
      familyRule3Title: '生まれながらの平等',
      familyRule3Text: '肩書き・役割・経験に関わらず、私たちはみな兄弟姉妹。肩書きが価値を決めることはない。心が決める。',
    }
  };
  ...
  const tooltipDescriptions = {
    founder: 'Sets the vision and serves the family above all else.',
    cofounder: 'Shares the vision and helps build the family alongside the founder.',
    vp: 'Supports the founder and oversees senior leads across their domain.',
    senpai: 'Guides their domain and mentors creators and testers.',
    support: 'Keeps the family running smoothly with essential operations.',
    creator: 'Makes their own creations by their own decision and passion.',
    tester: 'Tests all creations for quality, fun, and alignment with our standards.'
  };

  document.querySelectorAll('.org-card').forEach(card => {
    const titleEl = card.querySelector('.org-title');
    if (!titleEl) return;
    let type = null;
    for (const cls of ['founder','cofounder','vp','senpai','support','creator','tester']) {
      if (card.classList.contains(cls)) { type = cls; break; }
    }
    if (!type) return;
    const tooltip = document.createElement('div');
    tooltip.className = 'org-tooltip';
    tooltip.innerHTML = `<h4>${titleEl.textContent.trim()}</h4><p>${tooltipDescriptions[type]}</p>`;
